<template>
  <div class="home page-component">
    ...
    <div class="v-scroll-list hospital-list">
      <div v-for="item in list" :key="item.id" class="v-card clickable list-item space">
      <div class="">
...
export default {
  ...
  //  条件查询医院列表
    ...
    querySearchAsync(queryString, cb) {
      this.searchObj = []
      if(queryString == '') return  // 这里的逻辑是当这个参数为空，就返回空  不能和下面同一行，否则就会搜索框下面就会显示不了
      hospApi.getByHosName(queryString).then(response => { // 根据输入的内容进行模糊查询
